...
public class AppConstants {
	...
	public interface HTTPURL {
		 ...
		 * 第二页
		 */
		public static final String paperlist = serverIP + "/terminal_interface/expert_comments_list.json?per_page=10&page=";//GET 后面跟页数
		public static final String paperInfo = serverIP + "/terminal_interface/expert_comments_show.json?id=";//GET后面跟着ID
		public static final String commentlist = serverIP + "/terminal_interface/user_comment_list.json?per_page=10&comment_id="; //跟着commentid和page
		public static final String commentpost = serverIP + "/terminal_interface/user_comment.json";//POST user_id comment_id content
		public static final String praise = serverIP + "/terminal_interface/praise.json?id=";//后面跟文章ID
